...
import common as C  # noqa: F401  (pins DARKSIRENS_ZMAX before darksirens)
...
def main() -> None:
    surv = C.DATA_DIR / "pixelated_n64" / "catalog_pixelated_nside_64.h5"
    fitp = C.DATA_DIR / "selection_fit_union.json"
