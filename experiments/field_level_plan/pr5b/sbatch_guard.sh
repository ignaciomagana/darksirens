...
#SBATCH --mem=128G
#SBATCH -t 01:00:00
#SBATCH -o /hildafs/projects/phy230014p/magana/src/darksirens-dev/experiments/field_level_plan/pr5b/guard_%j.out
#SBATCH -e /hildafs/projects/phy230014p/magana/src/darksirens-dev/experiments/field_level_plan/pr5b/guard_%j.err
...
# arm + MAP arm]) ~= 20 min of evaluation; -t 01:00:00 is deliberate slack.
set -euo pipefail
...
time python $REPO/experiments/field_level_plan/pr5b/run_guard_arm.py
