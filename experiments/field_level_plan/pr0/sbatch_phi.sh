...
#SBATCH --mem=96G
#SBATCH -t 08:00:00
#SBATCH -o /hildafs/projects/phy230014p/magana/src/darksirens-dev/experiments/field_level_plan/pr0/phi_%j.out
#SBATCH -e /hildafs/projects/phy230014p/magana/src/darksirens-dev/experiments/field_level_plan/pr0/phi_%j.err
...
python ../field_level_plan/pr0/compute_phi.py
