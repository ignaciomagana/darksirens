...
def main():
    ...
    g.add_argument("--universe_model", default="spectral_sirens",
                   choices=["spectral_sirens", "spectral_sirens_wl", "dark_sirens", "dark_sirens_complete", "bright_sirens"])
    ...
    g.add_argument(
        ...
        help="Lognormal WL variance amplitude: s²(z) = a·z^b. "
    ...
    g.add_argument(
        ...
        help="Path to HDF5 table of log p_WL(μ|z) (used with "
             "--lensing_wl_model tabulated).",
    )
